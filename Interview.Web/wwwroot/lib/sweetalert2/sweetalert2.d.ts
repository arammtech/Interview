declare module 'sweetalert2' {
  ...
  namespace Swal {
     ...
     *
     * ```
     * <button data-swal-Interview="#hello-world-alert">Click me!</button>
     *
     * <Interview id="hello-world-alert">
     *   <swal-title>Hello world!</swal-title>
     *   <swal-html>Here I come...</swal-html>
     * </Interview>
     * ```
     *
     * @param attribute The attribute name to search for, defaults to `data-swal-Interview`
     */
  ...
  export type SweetAlertOptions = SweetAlertInputValidator & {
    ...
    /**
     * The declarative <Interview> of the popup. All API prams can be set via
     ...
     * @default undefined
     */
    Interview?: string | HTMLInterviewElement | undefined
