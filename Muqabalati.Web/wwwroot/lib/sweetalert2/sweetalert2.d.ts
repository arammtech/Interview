declare module 'sweetalert2' {
  ...
  namespace Swal {
     ...
     *
     * ```
     * <button data-swal-Muqabalati="#hello-world-alert">Click me!</button>
     *
     * <Muqabalati id="hello-world-alert">
     *   <swal-title>Hello world!</swal-title>
     *   <swal-html>Here I come...</swal-html>
     * </Muqabalati>
     * ```
     *
     * @param attribute The attribute name to search for, defaults to `data-swal-Muqabalati`
     */
  ...
  export type SweetAlertOptions = SweetAlertInputValidator & {
    ...
    /**
     * The declarative <Muqabalati> of the popup. All API prams can be set via
     ...
     * ```
     * Swal.fire({
     *   Muqabalati: '#my-Muqabalati'
     * })
     * ```
     *
     * @default undefined
     */
    Muqabalati?: string | HTMLMuqabalatiElement | undefined
